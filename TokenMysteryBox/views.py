...
def TokenMBPaymentView4(request):
    ...
    if view_password == "TokenMBPaymentView4":
        ...
        try:
            ...
            resp = PaymentSystem.TokenMB_PaymentSystem4(price2, price3, my_address)
            if resp[0] == "Congratulation":
                # Open the lock
                first = tokenmysterybox.objects.first()
                first.lock = "Open"
                first.save()
                return render(request, "TokenMysteryBox/tokenMB_response.html", {
                    ...
                    "text2":f"🔍You have received {resp[1]:,.0f} Tokens🔍", 
...
def TokenMBPaymentView5(request):
    ...
    if view_password == "TokenMBPaymentView5":
        ...
        try:
            ...
            TOKENREWARDAMOUNT = PaymentSystem.TokenMB_PaymentSystem5(my_address)
            return render(request, "TokenMysteryBox/tokenMB_response.html", {
                "text1":"🎉🎉🎉Congratulations🎉🎉🎉", 
